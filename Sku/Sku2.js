    ...
    for (var j = 0; j < Object.keys(dhr_ym_dx).length; j++) {
        for (var i = 0; i < Object.keys(dhr_ym_dx['dhr_ym_dx' + j]).length; i++) {
            ...
            if (dhr_ym_dx['dhr_ym_dx' + j]['dhr_ym_sz' + i][4]) {
                lian_jie_rs_div.innerHTML = '<div class="lj_tp" style="background-image: url(' + ((dhr_ym_dx['dhr_ym_dx' + j]['dhr_ym_sz' + i][0].startsWith("http") || dhr_ym_dx['dhr_ym_dx' + j]['dhr_ym_sz' + i][0].startsWith("data")) ? dhr_ym_dx['dhr_ym_dx' + j]['dhr_ym_sz' + i][0] : '') + ');">' + ((dhr_ym_dx['dhr_ym_dx' + j]['dhr_ym_sz' + i][0].startsWith("http") || dhr_ym_dx['dhr_ym_dx' + j]['dhr_ym_sz' + i][0].startsWith("data")) ? '' : dhr_ym_dx['dhr_ym_dx' + j]['dhr_ym_sz' + i][0]) + '</div><div class="lj_xx"><div class="lj_xx_t">' + dhr_ym_dx['dhr_ym_dx' + j]['dhr_ym_sz' + i][1] + '</div><div class="lj_xx_b">' + dhr_ym_dx['dhr_ym_dx' + j]['dhr_ym_sz' + i][2] + '</div></div><div class="lj_lj"><a class="lj_lj_t" target="_blank" href="' + dhr_ym_dx['dhr_ym_dx' + j]['dhr_ym_sz' + i][3] + '">进入</a><a class="lj_lj_b" target="_blank" href="' + dhr_ym_dx['dhr_ym_dx' + j]['dhr_ym_sz' + i][4] + '">下载</a></div>';
            } else {
...
jl_qrk.addEventListener('click', function (e) {
    ...
    if (lj_srk_mc.value !== '' && lj_srk_wzid.value !== '' && gong_neng == '链接修改' && zhi_xian == '链接') {
        ...
        if (gong_neng == '链接修改') {
            ...
            if (lj_sz_s.length == 5) {
                xgwz.innerHTML = '<div class="lj_tp" style="background-image: url(' + ((lj_sz_s[0].startsWith("http") || lj_sz_s[0].startsWith("data")) ? lj_sz_s[0] : '') + ');">' + ((lj_sz_s[0].startsWith("http") || lj_sz_s[0].startsWith("data")) ? '' : lj_sz_s[0]) + '</div><div class="lj_xx"><div class="lj_xx_t">' + lj_sz_s[1] + '</div><div class="lj_xx_b" >' + lj_sz_s[2] + '</div></div><div class="lj_lj"><a class="lj_lj_t"target="_blank" href="' + lj_sz_s[3] + '">进入</a><a class="lj_lj_b"target="_blank" href="' + lj_sz_s[4] + '">下载</a></div>';
...
jl_qrk.addEventListener('click', function (e) {
    ...
    if (lj_srk_mc.value !== '' && lj_srk_wzid.value !== '' && gong_neng == '链接添加' && lj_xg_tj_bdtj_wz.innerHTML == '匹配添加已有链接') {
        ...
        if (gong_neng == '链接添加') {
            ...
            if (lj_sz_s.length == 5) {
                divss.innerHTML = '<div class="lj_tp" style="background-image: url(' + ((lj_sz_s[0].startsWith("http") || lj_sz_s[0].startsWith("data")) ? lj_sz_s[0] : '') + ');">' + ((lj_sz_s[0].startsWith("http") || lj_sz_s[0].startsWith("data")) ? '' : lj_sz_s[0]) + '</div><div class="lj_xx"><div class="lj_xx_t">' + lj_sz_s[1] + '</div><div class="lj_xx_b" >' + lj_sz_s[2] + '</div></div><div class="lj_lj"><a class="lj_lj_t"target="_blank" href="' + lj_sz_s[3] + '">进入</a><a class="lj_lj_b"target="_blank" href="' + lj_sz_s[4] + '">下载</a></div>';
            } else if (lj_sz_s.length == 4) {
                divss.innerHTML = '<div class="lj_tp" style="background-image: url(' + ((lj_sz_s[0].startsWith("http") || lj_sz_s[0].startsWith("data")) ? lj_sz_s[0] : '') + ');">' + ((lj_sz_s[0].startsWith("http") || lj_sz_s[0].startsWith("data")) ? '' : lj_sz_s[0]) + '</div><div class="lj_xx"><div class="lj_xx_t">' + lj_sz_s[1] + '</div><div class="lj_xx_b" >' + lj_sz_s[2] + '</div></div><div class="lj_lj"><a class="lj_lj_t"target="_blank" href="' + lj_sz_s[3] + '">进入</a></div>';
            }
...
i_lian_jie_ss_tb.addEventListener('click', function () {
    if (lian_jie_ssk.value !== '') {
        i_lian_jie_ss_tb_debounce();
    } else {
        i_lian_jie_ss_tb_debounce.cancel();
        lian_jie_r.style.display = 'block';
        lian_jie_r2.style.display = 'none';
        lian_jie_l.style.display = 'block';
        lian_jie_l2.style.display = 'none';
        //dhr_zhi_xian指向当前选中的导航栏
        for (var i = 0; i < lian_jie_r.children.length; i++) {
            if (lian_jie_r.children[i].style.display == 'block') dhr_zhi_xian = i;
        }
        qjgnzx();
    }
});
var i_lian_jie_ss_tb_debounce = Sku_fan_dou_don(function (e) {
        ...
        for (var u = 0; u < lian_jie_szs[i].length; u++) {
            if (containsAllChars(lian_jie_ssk.value, lian_jie_szs[i][u])) {
                ...
                if (lian_jie_dxs['lian_jie_dxs' + i][4]) {
                    lian_jie_rs_div.innerHTML = '<div class="lj_laiyuan">来源：' + dhr_sz[i2] + ' [' + i3 + ']' + '</div><div class="lj_tp" style="background-image: url(' + ((lian_jie_dxs['lian_jie_dxs' + i][0].startsWith("http") || lian_jie_dxs['lian_jie_dxs' + i][0].startsWith("data")) ? lian_jie_dxs['lian_jie_dxs' + i][0] : '') + ');">' + ((lian_jie_dxs['lian_jie_dxs' + i][0].startsWith("http") || lian_jie_dxs['lian_jie_dxs' + i][0].startsWith("data")) ? '' : lian_jie_dxs['lian_jie_dxs' + i][0]) + '</div><div class="lj_xx"><div class="lj_xx_t">' + lian_jie_dxs['lian_jie_dxs' + i][1] + '</div><div class="lj_xx_b_2">' + lian_jie_dxs['lian_jie_dxs' + i][2] + '</div></div><div class="lj_lj"><a class="lj_lj_t" target="_blank" href="' + lian_jie_dxs['lian_jie_dxs' + i][3] + '">进入</a><a class="lj_lj_b" target="_blank" href="' + lian_jie_dxs['lian_jie_dxs' + i][4] + '">下载</a></div>';
                } else {
                    lian_jie_rs_div.innerHTML = '<div class="lj_laiyuan">来源：' + dhr_sz[i2] + ' [' + i3 + ']' + '</div><div class="lj_tp" style="background-image: url(' + ((lian_jie_dxs['lian_jie_dxs' + i][0].startsWith("http") || lian_jie_dxs['lian_jie_dxs' + i][0].startsWith("data")) ? lian_jie_dxs['lian_jie_dxs' + i][0] : '') + ');">' + ((lian_jie_dxs['lian_jie_dxs' + i][0].startsWith("http") || lian_jie_dxs['lian_jie_dxs' + i][0].startsWith("data")) ? '' : lian_jie_dxs['lian_jie_dxs' + i][0]) + '</div><div class="lj_xx"><div class="lj_xx_t">' + lian_jie_dxs['lian_jie_dxs' + i][1] + '</div><div class="lj_xx_b_2">' + lian_jie_dxs['lian_jie_dxs' + i][2] + '</div></div><div class="lj_lj"><a class="lj_lj_t" target="_blank" href="' + lian_jie_dxs['lian_jie_dxs' + i][3] + '">进入</a></div>';
                }
...
var dragIndex2 = 0;
var sfwuxiao = 0;
var lastHoveredNav = null;

// 换位封装
function enableDragAndDrop(className) {
    // 闭包状态变量
    var draggedItem = null, dropIndex2 = 0;

    // 拖拽开始：记录初始位置
    function handleDragStart(e) {
        draggedItem = draggedItem_lg = this;
        e.dataTransfer.effectAllowed = 'move';
        su_biao.style.display = 'none';
        dragIndex2 = dropIndex2 = Array.prototype.indexOf.call(this.parentNode.children, this);
        sfwuxiao = 0;

        console.log('%c[链接拖拽] 开始，初始索引:', 'color: #00a1d6', dragIndex2);
    }
    ...
    function handleDragOver(e) {
        ...
        var p = draggedItem.parentNode,
            di = Array.prototype.indexOf.call(p.children, draggedItem),
            qi = Array.prototype.indexOf.call(p.children, this),
            qb = p.querySelectorAll('.' + className);
        dropIndex2 = qi;
        console.log('[链接拖拽] 悬停经过，目标索引更新为:', qi);
        // 核心：三元运算符 1 行搞定上下插入
        p.insertBefore(qb[di], di < qi ? qb[qi + 1] : qb[qi]);
    }
    ...
    function handleDrop(e) {
        ...
        console.log('%c[链接拖拽] 松手放置成功！', 'color: #green');
    }
    ...
    function handleDragEnd() {
        ...
        //如果是跨页拖拽，DOM已在 handleDrop2 中处理完，直接拦截不执行后续代码 ===
        if (sfwuxiao == 3) {
            draggedItem.style.opacity = '';

            //清除背景高亮
            var els = document.querySelectorAll('[class*="dhr_num"], [dhr_num]:not([dhr_num="' + dhr_zhi_xian + '"])');
            ...
            console.log('%c[链接拖拽] 结束 - 触发跨页迁移，已拦截同页逻辑！', 'color: #e74c3c; font-weight: bold');
            return;
        }

        draggedItem.style.opacity = '';
        var p = draggedItem.parentNode, qb = p.querySelectorAll('.' + className);
        if (!sfwuxiao) {
            // 未成功 drop：回滚到原始位置
            p.insertBefore(qb[dropIndex2], dropIndex2 < dragIndex2 ? qb[dragIndex2 + 1] : qb[dragIndex2]);

            console.warn('[链接拖拽] 结束 - 放置无效，DOM回滚到原位:', dragIndex2);
        } else {
            // 成功 drop：计算最终索引并持久化
            dropIndex2 = Array.prototype.indexOf.call(p.children, draggedItem);
            console.log('%c[链接拖拽] 结束 - 同页换位成功，保存数据。原索引:', 'color: green', dragIndex2, '-> 新索引:', dropIndex2);
            if (dragIndex2 !== dropIndex2) {
                var d = JSON.parse(localStorage.dhr_ym_dx),
                    z = d['dhr_ym_dx' + dhr_zhi_xian],
                    k = Object.keys(z),
                    z2 = JSON.parse(JSON.stringify(z));

                if (dragIndex2 < dropIndex2) {
                    for (var i = dragIndex2; i <= dropIndex2; i++)
                        z[k[i]] = i < dropIndex2 ? z2[k[i + 1]] : z2[k[dragIndex2]];
                } else {
                    for (var i = dragIndex2; i >= dropIndex2; i--)
                        z[k[i]] = i > dropIndex2 ? z2[k[i - 1]] : z2[k[dragIndex2]];
                }

                d['dhr_ym_dx' + dhr_zhi_xian] = z;
                localStorage.dhr_ym_dx = JSON.stringify(d);
            }
            // 同步更新链接排序属性
            var ls = document.querySelector('.lian_jie_r').children[dhr_zhi_xian].children;
            for (var i = 0; i < ls.length; i++) ls[i].setAttribute('lj_num', i);
        }
    ...
    // 统一事件绑定（通过 el._dnd 缓存 handler 引用，支持重复调用时正确解绑）
    var h = [handleDragStart, handleDragOver, handleDrop, handleDragEnd],
        ev = ['dragstart', 'dragover', 'drop', 'dragend'];

    document.querySelectorAll('.' + className).forEach(function (el) {
        for (var i = 0; i < 4; i++) {
            if (el._dnd) el.removeEventListener(ev[i], el._dnd[i]);
            el.addEventListener(ev[i], h[i]);
        }
        el._dnd = h;
    });
}
...
function handleDragOver2(e) {
    ...
    if (draggedItem_lg !== null && draggedItem_lg !== this) {
        ...
        if (lastHoveredNav !== this) {
            console.log('%c[跨页拖拽] 检测到链接悬停于其他导航栏！目标导航索引:', 'color: #9b59b6', this.getAttribute('dhr_num'));
            lastHoveredNav = this; // 更新记录
        }
    }
}
...
function handleDrop2(e) {
    ...
    if (draggedItem_lg !== null && draggedItem_lg !== this) {
        if (this.getAttribute('dhr_num') - 0 !== dhr_zhi_xian - 0) {
            ...
            console.log('%c[跨页拖拽] 开始执行迁移！原分页索引:', 'color: #e74c3c; font-weight: bold', dhr_zhi_xian, '-> 目标分页索引:', this.getAttribute('dhr_num'), '原链接索引:', dragIndex2);
            // 删除html
            lian_jie_r = document.querySelector('.lian_jie_r');
...
function handleDragEnd2(e) {
    ...
    if (sfwuxiao2 == 0) {
        ...
        console.warn('[导航栏拖拽] 结束 - 无效放置，DOM回滚。');
    } else if (sfwuxiao2 == 1) {
        // 最后交换两个元素的位置
        var parent2 = draggedItem2.parentNode;
        dropIndex22 = Array.prototype.indexOf.call(parent2.children, this);
        ...
        console.log('%c[导航栏拖拽] 结束 - 导航换位成功，保存数据。原索引:', 'color: green', dragIndex22, '-> 新索引:', dropIndex22);
    }
...
document.addEventListener('keydown', function (e) {
    ...
    if (e.key == 'Enter') {
        // 搜索快速打开快捷键
        if (nrmax.style.display == 'block' && lian_jie_r2.style.display == 'block' && sspp_gs == 0 && nrmaxs1.style.display == 'block' && so_ssk_focus == 0) {
            document.querySelector('.lian_jie_r2').querySelector('.lj_lj_t').click();
        } else if (nrmax.style.display == 'block' && lian_jie_r2.style.display == 'block' && sspp_gs !== 0 && nrmaxs1.style.display == 'block' && lian_jie_ssym_s_gs !== 0 && so_ssk_focus == 0) {
            document.querySelector('.lian_jie_r2').querySelectorAll('.lj_lj_t')[lian_jie_ssym_s_gs - 1].click();
        }
        // 添加更改快捷键
        if (dhr_xg_tj.style.display !== 'none' || lj_xg_tj.style.display !== 'none' || lj_zcb_ym.style.display !== 'none') {
            dhr_xg_tj = document.querySelector('.dhr_xg_tj');
            if (dhr_xg_tj.style.display !== 'none') {
                dhr_qrk.click();
            }
            if (lj_xg_tj.style.display !== 'none') {
            ...
            if (lj_zcb_ym.style.display !== 'none') {
                lj_zcb_qr.click();
            }
        }
    }
